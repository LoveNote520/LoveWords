...
class ThemeManager extends GetxController {
  ...
  final themeRed = ThemeData(
      colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xffD4BFEA)),
      useMaterial3: true,
      primaryColor: Colors.purpleAccent).obs;

  final currTheme = Rx<ThemeData>(ThemeData(
    primaryColor: const Color(0xff2b63d2),
    colorScheme: ColorScheme.fromSeed(  primary: const Color(0xffBFEAFF),seedColor: const Color(0xffBFEAFF)),
  ));
