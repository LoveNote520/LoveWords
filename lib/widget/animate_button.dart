...
class GuidingStarClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    leftPath.cubicTo(centerX - (size.width*0.69), size.height*0.66, centerX - (size.width*0.35), size.height*0.25, centerX, size.height*0.48);
    // 右半爱心
    rightPath.moveTo(centerX, size.height);
    rightPath.cubicTo(centerX + (size.width*0.69), size.height*0.66, centerX + (size.width*0.35), size.height*0.25, centerX, size.height*0.48);
